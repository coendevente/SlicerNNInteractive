...
\hypersetup{
  pdftitle={nnInteractiveSlicer: A 3D Slicer extension for
nnInteractive},
  pdfauthor={Coen de Vente, Kiran Vaidhya Venkadesh, Bram van Ginneken,
Clara I. Sánchez},
  pdflang={en-US},
  colorlinks=true,
  linkcolor={Maroon},
...
\texttt{nnInteractive} (\citeproc{ref-isensee2025nninteractive}{Isensee
et al., 2025}), a deep learning-based framework allowing for fast,
